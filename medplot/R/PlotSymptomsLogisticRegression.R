#' @title Return a list of result for logistic regression modeling
#' 
#' @description Returns a list containing results of logistic regression modeling. 
...
#' @param thresholdValue The threshold value for dichotomizing.
#' 
#' @export

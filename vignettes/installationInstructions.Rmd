...
%\VignetteIndexEntry{medplot installation instructions}
-->

# Installation instructions for the medplot package

After installing the [R programming language](http://cran.r-project.org/), use the console in R to iInstall the devtools package:
...
install_github(username="crtahlin", repo="medplot")
```
